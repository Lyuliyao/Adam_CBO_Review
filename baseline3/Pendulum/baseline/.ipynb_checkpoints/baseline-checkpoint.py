...
model = DDPG("MlpPolicy", env, tensorboard_log="./logs",verbose=1)
...
start_time = time.time()
model = TD3("MlpPolicy", env, tensorboard_log="./logs",verbose=1)
model.learn(total_timesteps=100_000, progress_bar=False)
...
start_time = time.time()
model = TQC("MlpPolicy", env, tensorboard_log="./logs",verbose=1)
model.learn(total_timesteps=100_000, progress_bar=False)
...
start_time = time.time()
model = CrossQ("MlpPolicy", env, tensorboard_log="./logs",verbose=1)
model.learn(total_timesteps=100_000, progress_bar=False)
